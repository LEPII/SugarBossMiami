...
const catalogData: CatalogItem[] = [
...

  {
    ...
    menuSection: "- Cupcakes -",
    hasImage: true,
    src: "https://placehold.co/400x300/F6A6B2/FFFFFF?text=Strawberry+Shortcake+Swirl",
  ...
  },
  {
    ...
    menuSection: "- Cupcakes -",
    hasImage: true,
    src: "https://placehold.co/400x300/4B4B4B/FFFFFF?text=Oreo+Cheesecake+Crush",
  ...
  },
  {
    ...
    menuSection: "- Cake Flavors -",
    hasImage: true,
    src: "https://placehold.co/400x300/8B1E2D/FFFFFF?text=Red+Velvet",
    alt: "Red Velvet cake",
    filters: {
      type: ["cake"],
      eventType: ["marriage-celebrations"],
  ...
  },
  {
    ...
    menuSection: "- Cake Flavors -",
    hasImage: true,
    src: "https://placehold.co/400x300/F8F3E7/333333?text=Coconut+Cream",
  ...
  },
  {
    ...
    hasImage: true,
    isPremium: true,
    src: "https://placehold.co/400x300/B6783E/FFFFFF?text=Salted+Caramel",
  ...
  },
  {
    ...
    menuSection: "- Frostings -",
    hasImage: true,
    src: "https://placehold.co/400x300/3B241C/FFFFFF?text=Chocolate+Ganache",
  ...
  },
  {
    ...
    hasImage: true,
    isPremium: true,
    src: "https://placehold.co/400x300/D9B8FF/333333?text=Luxury+Macaron+Box",
  ...
  },
  {
    ...
    menuSection: "- Specialty Desserts -",
    hasImage: true,
    src: "https://placehold.co/400x300/F4D6A0/333333?text=Custom+Cookie+Set",
